document.addEventListener("alpine:init", () => {
  Alpine.data("valenPage", () => ({
    ...
    operatorNames: ["SulAmérica", "Amil", "Bradesco Saúde", "Porto Saúde"],
    slides: [
      {
        ...
        image: "assets/hero-individual.jpg",
      ...
      },
      {
        ...
        image: "assets/hero-familiar.jpg",
      ...
      },
      {
        ...
        image: "assets/hero-empresarial.jpg",
